...
//-----------------------------------------------------------------------------------------------------------------------------------------------
        ...
        status = VL53L0X_SetLimitCheckEnable(myDev, VL53L0X_CHECKENABLE_SIGNAL_RATE_FINAL_RANGE,
                                             1); // Enable Signal limit
        if (status) {
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
        ...
        status = VL53L0X_SetGpioConfig(myDev, 0, VL53L0X_DEVICEMODE_CONTINUOUS_RANGING,
                                       VL53L0X_GPIOFUNCTIONALITY_THRESHOLD_CROSSED_LOW, VL53L0X_INTERRUPTPOLARITY_HIGH);
//-----------------------------------------------------------------------------------------------------------------------------------------------
